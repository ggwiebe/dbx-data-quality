...
# MAGIC 
# MAGIC ## Instructions:
# MAGIC 1. Run the notebook against a cluster with Databricks ML Runtime version 10.1.x-cpu, to best re-create the training environment.
...
model_name = "ggw_quality_red_wine"

# COMMAND ----------

# MAGIC %md
# MAGIC ## Environment Recreation
# MAGIC Run the notebook against a cluster with Databricks ML Runtime version 10.1.x-cpu, to best re-create the training environment.. The cell below downloads the model artifacts associated with your model in the remote registry, which include `conda.yaml` and `requirements.txt` files. In this notebook, `pip` is used to reinstall dependencies by default.
# MAGIC 
...
model_name = "ggw_quality_red_wine"
input_table_name = "ggw_wine.quality_red_wine_features"
# output_table_path = "/FileStore/batch-inference/ggw_quality_red_wine_inferenced"
output_table_path = "/users/glenn.wiebe@databricks.com/ggw_wine/ggw_wine.db/ggw_quality_red_wine_inferenced"
...
# output_df.write.save(f"{output_table_path}_{datetime.today()}")

output_df.write.save(f"{output_table_path}_2021_12_03")
# output_df.write.saveAsTable(f"{input_table_name}_Infer_2021-12-03")

# print(f"CREATE TABLE {input_table_name}_inferenced_2021_12_03 LOCATION '{output_table_path}_2021_12_03'")
spark.sql(f"CREATE TABLE {input_table_name}_inferenced_2021_12_03 LOCATION '{output_table_path}_2021_12_03'")


# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE TABLE ggw_wine.quality_red_wine_features_inferenced_2021_12_03
# MAGIC LOCATION "/users/glenn.wiebe@databricks.com/ggw_wine/ggw_wine.db/ggw_quality_red_wine_inferenced_2021_12_03"
